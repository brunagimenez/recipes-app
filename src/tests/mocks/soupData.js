const notRepeat1 = 'Chicken Stock';
const notRepeat2 = 'Spring Onions';
export const soupMeals = {
  meals: [
    {
      idMeal: '52973',
...
export const mockSoupFetch = () => Promise.resolve({
  status: 200,
  ok: true,
